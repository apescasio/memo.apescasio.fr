...
const DynamicCallout = ({ children }) => {
  ...
  const regex = /\(~([0-9\u0660-\u0669]+)\s(?:second|seconds|seconde|secondes|segundo|segundos|ثانية|ثانيتين|ثوان|ثوانٍ)\)/g; // added ثانيتين (dual form)
  ...
  return (
    <div className="callout">
      <Callout>
        {totalSeconds > 0
          ? `Total script estimation: ~${totalSeconds}s.`
          : 'Total script estimation: n/a'}
      </Callout>
