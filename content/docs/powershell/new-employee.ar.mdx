...
### خيار بديل لاسم مستخدم مخصص ###
   *(~4 ثوانٍ)* يمكن إدخال حساب مخصص يدوياً
  لإضافته إلى مجموعة المسؤولين.
</Step>

<Step>
### تحديث جرد Excel ###
   *(~3 ثوانٍ)* يُحدّث ملف Excel في مجلد مشترك يحتوي
  بيانات الحاسوب والمستخدم.
</Step>

<Step>
### إنشاء وطباعة نموذج الإعارة ###
   *(~4 ثوانٍ)* يُنشئ نموذج Word بمعلومات
