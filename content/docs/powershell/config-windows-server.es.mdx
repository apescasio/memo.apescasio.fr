...
<Step>
  ...
  Configurar la dirección IP estática, máscara de
...
<Step>
  ...
  Configurar el autoinicio de sesión
...
<Step>
  ...
  Crear una carpeta para almacenar scripts
...
<Step>
  ...
  Crear el script para configurar
...
<Step>
  ...
  Reiniciar el servidor para aplicar los
