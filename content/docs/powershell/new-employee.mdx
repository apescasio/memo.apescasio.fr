...
<Step>
  ...
  Génère une ligne de log contenant le nom
...
<Step>
  ...
  Invite l'utilisateur à entrer le
...
<Step>
  ### Renommage du PC ### 
  Propose un nom basé sur le prénom et le nom saisis,
...
<Step>
  ...
  Affiche une liste de comptes admins
...
<Step>
  ...
  Met à jour un fichier Excel dans un
