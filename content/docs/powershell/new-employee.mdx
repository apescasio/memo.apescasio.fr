---
title: Configuration d'un PC portable pour un nouveau salarié
---
...
Durant ma première alternance chez un groupe d'universités, j'ai dû faire une centaine d'intégration de nouveaux salariés.
