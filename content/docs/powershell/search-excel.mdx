...
Le script ouvre chaque fichier Excel, parcourt toutes les feuilles, et cherche la valeur saisie. Si elle est trouvée, il affiche le nom du fichier et de la feuille où elle se trouve. Si elle est présente dans plusieurs fichiers, tous sont listés *(~30 secondes)*.
</Step>
