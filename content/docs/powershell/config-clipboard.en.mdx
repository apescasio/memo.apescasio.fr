...
At the beginning of my second apprenticeship, I quickly realized that some tasks were recurring—especially writing the same sentences to close out "tickets."
...
Create a list containing commonly used phrases in tickets. The phrases are bilingual (French / English) to allow for quick reuse depending on context *(~4 seconds)*.
</Step>
...
Then once the script was executed, I could see all my phrases.
