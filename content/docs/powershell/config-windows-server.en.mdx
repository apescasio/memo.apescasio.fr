...
In almost all classes concerning Windows Server at IPI, I had to reinstall a Windows Server with AD DS, DNS, DHCP manually in VMWare. So, I decided to create this script to automate the entire process with preconfigured IP configurations.
