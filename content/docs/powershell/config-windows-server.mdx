...
<Step>
  ...
  Configurer l'adresse IP statique, le masque de
...
<Step>
  ...
  Configurer l'Autologon pour que
...
<Step>
  ...
  Créer un dossier pour stocker les
...
<Step>
  ...
  Créer le script pour configurer
...
<Step>
  ...
  Redémarrer le serveur pour appliquer les
