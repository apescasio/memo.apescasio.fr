...
<Step>
  ...
  Genera una entrada de registro que contiene el
...
<Step>
  ...
  Solicita al usuario que ingrese el
...
<Step>
  ### Renombrar la PC ### 
  Sugiere un nombre basado en el nombre y apellido
...
<Step>
  ...
  Utiliza la cuenta de administrador
...
<Step>
  ...
  Actualiza un archivo Excel en una
