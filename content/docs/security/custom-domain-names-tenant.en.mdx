...
Although I rent from Netcup DE, I'm using [Cloudflare's DNS](https://developers.cloudflare.com/dns/zone-setups/full-setup/setup/) instead of Netcup's because I think it's much better. 
...
![SPF MX setup step 6](/images/security/custom-domain-names-admin-microsoft-com-spf-mx-6.png)
