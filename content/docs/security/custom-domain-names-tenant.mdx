...
Bien que je loue chez Netcup DE, j'utilise le [DNS de Cloudflare](https://developers.cloudflare.com/dns/zone-setups/full-setup/setup/) au lieu de celui de Netcup car je pense que c'est beaucoup mieux.
