...
**Microsoft Intune** is a cloud service for mobile device management (MDM - **Mobile Device Management**) and mobile application management (MAM - **Mobile Application Management**). It allows companies to remotely manage workstations, laptops, phones, and tablets, whether they are personal (BYOD) or company-owned.
...
**Windows Autopilot** is a feature complementary to Intune that allows you to prepare and automatically deploy Windows devices without using a traditional image or requiring manual IT intervention.
