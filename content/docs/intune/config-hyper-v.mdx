---
title: Configurer Hyper-V pour mon lab Intune
---

## Contexte

J'ai voulu préparer une machine virtuelle (VM) à connecter à un lab Intune. 
...
J'ai executé PowerShell en tant qu'admin pour lancer cette commande qui va forcer le fichier de démarrage de Windows (boot config data ou BCD) de charger l'hyperviseur automatiquement.
