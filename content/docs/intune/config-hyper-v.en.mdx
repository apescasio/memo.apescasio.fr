---  
title: Configure Hyper-V for my Intune lab  
---

## Context

I wanted to prepare a virtual machine (VM) to connect to an Intune lab.
...
## Creating a VM for my Intune lab
...
I selected the Pro version. If I kept the Home version, I wouldn’t be able to enroll the VM in my Intune lab.
