...
This experience inspired me to use Voice Control on iPhone and Voice Access on Windows to execute voice commands through AI Agents in Copilot Studio, creating a more intuitive and « hands-free » way to work.
...
beginDialog:
  ...
  actions:
    ...
    - kind: SendActivity
      id: sendActivity_lTpub7
      activity: token_response = {Topic.token_response}
